...
<div class="container">
  ...
  <div class="bulk border-bottom border-dark w-100">
    ...
    <div class="m-0 row border-top border-bottom border-dark">
      ...
      <div class="col col-2 border-start">Name</div>
      <div class="col col-2 border-start">barcode</div>
      <div class="col col-2 border-start"> price</div>
      <div class="col col-1 border-start"> unit</div>
      <div class="col col-2 border-start">created_at</div>
      <div class="col col-2 border-start">Controls</div>
    </div>
    @php $c=0 @endphp
    ...
    <div class="row m-0">
      ...
      <div class="col col-2 border-start">
        <button type="button" data-bs-toggle="tooltip" title="Show product Information"
          class="trigger-wrapper btn">
          <i data-bs-toggle="modal" data-bs-target="#displayProduct"
            data-url="{{ route('view.product.info', ['id' => $product->id]) }}"
            class="displayProductTrigger fa fa-eye"></i>
        </button>
        <button type="button" data-bs-toggle="tooltip" title="edit Product " class="trigger-wrapper btn">
          <i data-bs-toggle="modal"
            data-bs-target="#editProduct"
            data-url="{{ route('edit.product.info', ['id' => $product->id]) }}"
            class="editProductTrigger fa fa-edit"></i>
        </button>
        ...
        <button class="btn btn-sm"
          ...
          <a href="{{ route('destroy.product', [$product->id]) }}"><i class="fa fa-trash"></i></a>
        </button>
